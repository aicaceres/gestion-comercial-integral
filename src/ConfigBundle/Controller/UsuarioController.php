  ...
  public function profileUpdateAction(Request $request)
  {
    ...
    if ($form->isValid()) {
      if (null == $entity->getPassword()) {
        ...
        // verificar si existe otro usuario con ese password
        $existe = $this->getUserByPassword($entity->getPassword());
        if ($existe) {
          $this->addFlash('error', 'El password ya existe en el sistema. Debe indicar uno distinto!');
          return array(
            'entity'      => $entity,
            'form'   => $form->createView()
          );
