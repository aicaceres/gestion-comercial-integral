...
/**
 * VentasBundle\Entity\FacturaDetalle
 * @ORM\Table(name="ventas_factura_detalle")
 * @ORM\Entity()
 */
class FacturaDetalle {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="VentasBundle\Entity\Factura", inversedBy="detalles")
    ...
    public function getTotal() {
        return ($this->getSubTotal() - $this->getMontoDescuento()) + $this->getIva();
    }
